...
object ProgramUtils {
  ...
  def isFunctionInjective(function: sil.Function, prog: sil.Program) = isFunctionInjective(function, prog, function.formalArgs.zipWithIndex.map{ case (_, index) => index }.toSet)
