...
case class QuantifiedPermissionsState2(isTop: Boolean = false,
  ...
  lazy val preFirstRunInfo = Context.preFirstRunInfo(currentPP)

  // result of the alias analysis after the current program point
  lazy val postFirstRunInfo = Context.postFirstRunInfo(currentPP)
  ...
  /** Inhales permissions.
    ...
    */
  override def inhale(acc: Expression): QuantifiedPermissionsState2 = ???
  ...
  /** Exhales permissions.
    ...
    */
  override def exhale(acc: Expression): QuantifiedPermissionsState2 = ???
  ...
  override def pruneUnreachableHeap(): QuantifiedPermissionsState2 = ???

  /** Removes all variables satisfying filter. */
  override def pruneVariables(filter: (VariableIdentifier) => Boolean): QuantifiedPermissionsState2 = ???

  /** Removes the current expression.
    *
    * @return The abstract state after removing the current expression
    */
  override def removeExpression(): QuantifiedPermissionsState2 = ???
  ...
  /** Sets the current expression.
    ...
    */
  override def setExpression(expr: ExpressionSet): QuantifiedPermissionsState2 = ???
  ...
  /** Throws an exception.
    ...
    */
  override def throws(t: ExpressionSet): QuantifiedPermissionsState2 = ???
  ...
  /** Returns a new instance of the lattice.
    ...
    */
  override def factory(): QuantifiedPermissionsState2 = ???

  /** Returns the top value of the lattice.
    *
    * @return The top value, that is, a value x that is greater than or equal to any other value
    */
  override def top(): QuantifiedPermissionsState2 = ???

  /** Returns the bottom value of the lattice.
    *
    * @return The bottom value, that is, a value x that is less than or to any other value
    */
  override def bottom(): QuantifiedPermissionsState2 = ???
