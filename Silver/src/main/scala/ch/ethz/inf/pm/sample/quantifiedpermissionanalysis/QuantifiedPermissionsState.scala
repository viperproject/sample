...
QuantifiedPermissionsState = Top, bottom: QuantifiedPermissionsState = Bottom) extends
  ...
  def numDom: Apron.Polyhedra

  def currentPP: ProgramPoint

  // fields declared within the program
  def fieldSet: Set[(Type, String)]

  def DefaultTrue = new Constant("true", BoolType, currentPP)

  def DefaultFalse = new Constant("false", BoolType, currentPP)
  ...
  override def pruneUnreachableHeap(): QuantifiedPermissionsState = this
  ...
  override def undoPruneUnreachableHeap(preState: QuantifiedPermissionsState): QuantifiedPermissionsState = this
  ...
  override def undoPruneVariables(unprunedPreState: QuantifiedPermissionsState, filter: (VariableIdentifier) =>
    Boolean): QuantifiedPermissionsState = this
