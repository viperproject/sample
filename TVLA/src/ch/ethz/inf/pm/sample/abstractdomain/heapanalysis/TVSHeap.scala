...
class TVSHeap extends HeapDomain[TVSHeap, NodeName] {
  ...
  def getCollectionTupleByValue(valueId: Assignable) : Assignable = throw new NotImplementedException("not implemented yet")
  def getCollectionTuples(collection: Assignable) = throw new NotImplementedException("not implemented yet")
  def getCollectionKeys(collection: Assignable) = throw new NotImplementedException("not implemented yet")
  def getCollectionValues(collection: Assignable) = throw new NotImplementedException("not implemented yet")
  ...
  def clearCollection(collection: Assignable) = throw new NotImplementedException("not implemented yet")
