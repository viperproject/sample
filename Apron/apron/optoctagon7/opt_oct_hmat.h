...
void meet_avx_half(opt_oct_mat_t *m, opt_oct_mat_t *m1, opt_oct_mat_t *m2, int dim, bool destructive);
void forget_array_avx_half(opt_oct_mat_t *m, ap_dim_t *arr,int dim, int arr_dim, bool project);
void join_avx_half(opt_oct_mat_t *m, opt_oct_mat_t *m1, opt_oct_mat_t *m2, int dim, bool destructive);
