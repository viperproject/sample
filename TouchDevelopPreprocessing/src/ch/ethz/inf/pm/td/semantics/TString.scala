...
class TString extends AAny {
  ...
  override def forwardSemantics[S <: State[S]](this0: ExpressionSet, method: String, parameters: List[ExpressionSet], returnedType: TouchType)
    ...
    case "to boolean" =>
      Dummy[S](this0, method)
      TopWithInvalid[S](TBoolean.typ, "conversion to boolean may fail")

    /** Parses the string as a color. */
    case "to color" =>
      Dummy[S](this0, method)
      TopWithInvalid[S](TColor.typ, "conversion to color may fail")

    /** Parses the string as a date and time. */
    case "to datetime" =>
      Dummy[S](this0, method)
      TopWithInvalid[S](TDateTime.typ, "conversion to datetime may fail")

    /** Parses the string as a geo coordinate. */
    case "to location" =>
      Dummy[S](this0, method)
      TopWithInvalid[S](TLocation.typ, "conversion to location may fail")
    ...
    case "to time" =>
      Dummy[S](this0, method)
      TopWithInvalid[S](TNumber.typ, "conversion to time may fail")
