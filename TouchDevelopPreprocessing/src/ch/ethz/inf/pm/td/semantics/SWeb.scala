...
class SWeb extends AAny {
  ...
  override def forwardSemantics[S <: State[S]](this0:ExpressionSet, method:String, parameters:List[ExpressionSet])
    ...
    // DECLARATION AS FIELD: 
    //   /** Returns an empty json array */
    //   val field_json_array = new TouchField("json_array",TJson_Object.typ)
    ...
    // DECLARATION AS FIELD: 
    //   /** Returns an empty json object */
    //   val field_json_object = new TouchField("json_object",TJson_Object.typ)
    ...
    // FIELDS: , field_connection_name, field_connection_type, field_is_connected, field_json_array, field_json_object
