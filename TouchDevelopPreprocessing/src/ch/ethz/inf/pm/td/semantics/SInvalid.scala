...
class SInvalid extends Any {
  ...
  def forwardSemantics[S <: State[S]](this0:ExpressionSet, method:String, parameters:List[ExpressionSet])(implicit pp:ProgramPoint,state:S):S = method match {
    ...
    case "board" => Expr(invalid(TBoard.typ)) 	     	                                                                                // Creates an invalid Board instance
    case "boolean" => Expr(invalid(TBoolean.typ)) 	     	                                                                            // Creates an invalid Boolean instance
    //case "camera" => Expr(invalid(Camera.typ)) 	     	                                                                              // Creates an invalid Camera instance
    case "color" => Expr(invalid(TColor.typ)) 	     	                                                                                // Creates an invalid Color instance
    ...
    case "link" => Expr(invalid(TLink.typ)) 	     	                                                                                  // Creates an invalid Link instance
    //case "link_collection" => Expr(invalid(Link_Collection.typ)) 	     	                                                            // Creates an invalid Link Collection instance
    case "location" => Expr(invalid(TLocation.typ)) 	     	                                                                          // Creates an invalid Location instance
    ...
    case "number" => Expr(invalid(TNumber.typ)) 	     	                                                                              // Creates an invalid Number instance
    ...
    case "picture" => Expr(invalid(TPicture.typ)) 	     	                                                                            // Creates an invalid Picture instance
