...
class SLanguages extends AAny {
  ...
  override def forwardSemantics[S <: State[S]](this0: ExpressionSet, method: String, parameters: List[ExpressionSet], returnedType: TouchType)
    ...
    case "detect language" =>
      ...
      TopWithInvalid[S](TString.typ, "language detection service may not be reachable")
    ...
    case "picture to text" =>
      ...
      if (TouchAnalysisParameters.reportPrematurelyOnInternetAccess)
        Error[S](Field[S](Singleton(SWeb.typ), SWeb.field_is_connected).not(), "picture to text",
          "Check if the device is connected to the internet before using the connection")
      TopWithInvalid[S](TString.typ, "text recognition service may not be reachable")
    ...
    case "record text" =>
      if (TouchAnalysisParameters.reportPrematurelyOnInternetAccess)
        Error[S](Field[S](Singleton(SWeb.typ), SWeb.field_is_connected).not(), "record text",
          "Check if the device is connected to the internet before using the connection")
      TopWithInvalid[S](TString.typ, "speech recognition service may not be reachable")
    ...
    case "speak text" =>
      ...
      TopWithInvalid[S](TSound.typ, "speech synthesis service may not be available")

    /** This api was renamed. Use `speak_text` instead. */
    case "speak" =>
      val List(lang, text) = parameters // String,String
      TopWithInvalid[S](TSound.typ, "speech synthesis service may not be reachable")
    ...
    case "translate" =>
      ...
      if (TouchAnalysisParameters.reportPrematurelyOnInternetAccess)
        Error[S](Field[S](Singleton(SWeb.typ), SWeb.field_is_connected).not(), "translate",
          "Check if the device is connected to the internet before using the connection")
      TopWithInvalid[S](TString.typ, "translation service may not be reachable")
