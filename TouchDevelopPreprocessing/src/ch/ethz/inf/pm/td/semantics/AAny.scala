...
/**
  ...
  */
trait AAny extends NativeMethodSemantics with RichExpressionSetImplicits with TouchType {
  ...
  private def matchRecordCalls[S <: State[S]](this0: RichExpressionSet, parameters: List[ExpressionSet], method: String,
  ...
  private def matchFields[S <: State[S]](this0: RichExpressionSet, parameters: List[ExpressionSet], method: String,
      returnedType: TouchType)(implicit state: S, pp: ProgramPoint): S = {
