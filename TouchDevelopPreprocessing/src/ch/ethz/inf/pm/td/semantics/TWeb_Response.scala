...
object TWeb_Response {
  ...
  val field_header_storage = new TouchField("__header",TString_Map.typ)
...
class TWeb_Response extends AAny {
  ...
  override def forwardSemantics[S <: State[S]](this0:ExpressionSet, method:String, parameters:List[ExpressionSet])
    ...
    case "header" =>
      ...
      CallApi[S](Field[S](this0,TWeb_Request.field_header_storage),"at",List(name))

    /** Gets the names of the headers */
    case "header_names" =>
      CallApi[S](Field[S](this0,TWeb_Request.field_header_storage),"keys")
