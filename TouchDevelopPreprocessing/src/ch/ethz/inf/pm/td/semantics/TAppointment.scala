...
object TAppointment {
  ...
  /** Gets the details */
  val field_details = new TouchField("details", TString.typName, topDefault = TopWithInvalidInitializer("appointment may not have details"))
  ...
  /** Gets the location */
  val field_location = new TouchField("location", TString.typName, topDefault = TopWithInvalidInitializer("appointment may not have a location"))
  ...
  /** Gets the subject */
  val field_subject = new TouchField("subject", TString.typName, topDefault = TopWithInvalidInitializer("appointment may not have a subject"))
