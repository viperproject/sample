...
object TContact {
  ...
  val field_first_name = new TouchField("first name",TString.typ)

  /** Gets the work address if any */
  val field_home_address = new TouchField("home address",TString.typ)

  /** Gets the home phone number if any */
  val field_home_phone = new TouchField("home phone",TLink.typ)

  /** Gets the job title at the company if any. */
  val field_job_title = new TouchField("job title",TString.typ)

  /** Gets the last name if any. */
  val field_last_name = new TouchField("last name",TString.typ)

  /** Gets the middle name if any. */
  val field_middle_name = new TouchField("middle name",TString.typ)

  /** Gets the cell phone number if any */
  val field_mobile_phone = new TouchField("mobile phone",TLink.typ)

  /** Gets the display name (not used when saving contact) */
  val field_name = new TouchField("name",TString.typ)

  /** Gets the nickname if any. */
  val field_nick_name = new TouchField("nick name",TString.typ)
  ...
  val field_personal_email = new TouchField("personal email",TLink.typ)

  /** Gets the cell or work or home phone number if any */
  val field_phone_number = new TouchField("phone number",TLink.typ)
  ...
  val field_web_site = new TouchField("web site",TLink.typ)

  /** Gets the home address if any */
  val field_work_address = new TouchField("work address",TString.typ)

  /** Gets the work email if any */
  val field_work_email = new TouchField("work email",TLink.typ)

  /** Gets the work phone number if any */
  val field_work_phone = new TouchField("work phone",TLink.typ)
