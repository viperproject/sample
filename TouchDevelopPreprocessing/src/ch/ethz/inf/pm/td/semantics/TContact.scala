...
object TContact {
  ...
  val field_birthday = new TouchField("birthday",TDateTime.typName)

  /** Gets the company name if any. */
  val field_company = new TouchField("company",TString.typName)

  /** Gets the work or personal email if any */
  val field_email = new TouchField("email",TLink.typName)

  /** Gets the first name if any. */
  val field_first_name = new TouchField("first name",TString.typName)

  /** Gets the work address if any */
  val field_home_address = new TouchField("home address",TString.typName)

  /** Gets the home phone number if any */
  val field_home_phone = new TouchField("home phone",TLink.typName)

  /** Gets the job title at the company if any. */
  val field_job_title = new TouchField("job title",TString.typName)

  /** Gets the last name if any. */
  val field_last_name = new TouchField("last name",TString.typName)

  /** Gets the middle name if any. */
  val field_middle_name = new TouchField("middle name",TString.typName)

  /** Gets the cell phone number if any */
  val field_mobile_phone = new TouchField("mobile phone",TLink.typName)
  ...
  val field_nick_name = new TouchField("nick name",TString.typName)

  /** Gets the office location at the company if any. */
  val field_office = new TouchField("office",TString.typName)

  /** Gets the personal email if any */
  val field_personal_email = new TouchField("personal email",TLink.typName)

  /** Gets the cell or work or home phone number if any */
  val field_phone_number = new TouchField("phone number",TLink.typName)
  ...
  val field_suffix = new TouchField("suffix",TString.typName)

  /** Gets the name title if any. */
  val field_title = new TouchField("title",TString.typName)

  /** Gets the web site if any */
  val field_web_site = new TouchField("web site",TLink.typName)

  /** Gets the home address if any */
  val field_work_address = new TouchField("work address",TString.typName)

  /** Gets the work email if any */
  val field_work_email = new TouchField("work email",TLink.typName)

  /** Gets the work phone number if any */
  val field_work_phone = new TouchField("work phone",TLink.typName)
