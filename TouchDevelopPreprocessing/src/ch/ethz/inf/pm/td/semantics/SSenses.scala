...
object SSenses extends Default_SSenses {
  ...
  override def member_on_shake =
    super.member_on_shake.copy(semantics = AAction.EnableSemantics(SSenses.field_shake_handler))

  override def member_on_phone_face_up =
    super.member_on_phone_face_up.copy(semantics = AAction.EnableSemantics(SSenses.field_phone_face_up_handler))

  override def member_on_phone_face_down =
    super.member_on_phone_face_down.copy(semantics = AAction.EnableSemantics(SSenses.field_phone_face_down_handler))

  override def member_on_phone_portrait =
    super.member_on_phone_portrait.copy(semantics = AAction.EnableSemantics(SSenses.field_phone_portrait))

  override def member_on_phone_landscape_left =
    super.member_on_phone_landscape_left.copy(semantics = AAction.EnableSemantics(SSenses.field_phone_landscape_left))

  override def member_on_phone_landscape_right =
    super.member_on_phone_landscape_right.copy(semantics = AAction.EnableSemantics(SSenses.field_phone_langscape_right))
