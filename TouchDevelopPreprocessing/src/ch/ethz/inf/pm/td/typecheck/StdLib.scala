...
trait StdLib extends AbstractSymbolTable {
  ...
  addSingleton("Contract", List( 
    ...
    Member("backwards", List("Boolean"), "Nothing"),
    Member("assertBackwards", List("Boolean","String"),"Nothing"),
    Member("assume", List("Boolean"),"Nothing"),
    Member("assumeBackwards", List("Boolean"),"Nothing")
  ))

  // General helpers (does not really exist in TouchDevelop... mostly added during preprocessing of scripts)
  addSingleton("Helpers", List(
    Member("cleanup", "Nothing") // may be used to do cleanup of temporary variables etc. at certain code locations
  ))
  ...
  addType("Ref", List(
    ...
    Member("◈ref", "Ref T") /* Retrive the reference itself (useful on globals and fields) */ ,
